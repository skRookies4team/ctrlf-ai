...
> **Base URL**: `http://{AI_GATEWAY_HOST}:{PORT}` > **문서 버전**: 2025-12-31 v3.0 (실제 AI 서버 API만 반영)
...
| Callback   | POST   | `/v1/internal_ragflow/internal/ai/callbacks/ragflow/ingest` | Active (Internal) |
