...
| `/v1/internal_ragflow/internal/ai/callbacks/ragflow/ingest` | POST   | RAGFlow 콜백 수신           |
...
| 컬렉션                      | 임베딩 모델                   | 차원 |
| --------------------------- | ----------------------------- | ---- |
| **ragflow_chunks_openai**   | OpenAI text-embedding-3-large | 3072 |
...
| AI_CALLBACK_TOKEN      | RAGFlow → AI 콜백      |
...
- **Milvus 컬렉션**: ragflow_chunks_openai vs ragflow_chunks_sroberta
- **LLM 모델**: 설정 가능
...
_이 보고서는 2026년 1월 3일 기준으로 작성되었습니다. (v1.1)_
